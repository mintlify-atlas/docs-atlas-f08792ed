...
- [Asset Checks](/concepts/asset-checks) - Quality gates for automation

## API Reference

- [`AutomationCondition`](https://docs.dagster.io/api/automation#dagster.AutomationCondition) - Base automation condition
- [`AutomationCondition.eager()`](https://docs.dagster.io/api/automation#dagster.AutomationCondition.eager) - Eager materialization
- [`AutomationCondition.on_cron()`](https://docs.dagster.io/api/automation#dagster.AutomationCondition.on_cron) - Cron-based automation
- [`AutomationCondition.on_missing()`](https://docs.dagster.io/api/automation#dagster.AutomationCondition.on_missing) - Materialize if missing
- [`code_version`](https://docs.dagster.io/api/assets#dagster.asset) - Track code changes
