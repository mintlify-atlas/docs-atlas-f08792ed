...
- [multi_asset](/api/definitions/multi-asset) - Define multiple assets computed by the same function
- [AssetIn](/api/definitions/asset-in) - Specify information about an asset input
- [AssetOut](/api/definitions/asset-out) - Specify information about an asset output
- [PartitionsDefinition](/api/definitions/partitions) - Define partitions for assets
