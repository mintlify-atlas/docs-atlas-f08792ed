...
- [@asset_sensor](/api/definitions/asset-sensor) - Sensor that triggers on asset materializations
- [@multi_asset_sensor](/api/definitions/multi-asset-sensor) - Sensor that monitors multiple assets
- [RunRequest](/api/definitions/run-request) - Request to launch a run
- [SkipReason](/api/definitions/skip-reason) - Skip sensor evaluation with a reason
- [SensorEvaluationContext](/api/definitions/sensor-evaluation-context) - Context for sensor evaluation
